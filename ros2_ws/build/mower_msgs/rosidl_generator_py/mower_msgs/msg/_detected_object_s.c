...
bool mower_msgs__msg__detected_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mower_msgs.msg._detected_object.DetectedObject", full_classname_dest, 46) == 0);
  }
  mower_msgs__msg__DetectedObject * ros_message = _ros_message;
  {  // label
...
PyObject * mower_msgs__msg__detected_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mower_msgs.msg._detected_object");
