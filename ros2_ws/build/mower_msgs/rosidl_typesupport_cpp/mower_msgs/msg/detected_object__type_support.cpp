...
static const _DetectedObject_type_support_symbol_names_t _DetectedObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mower_msgs, msg, DetectedObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mower_msgs, msg, DetectedObject)),
  }
};
...
{
  return &::mower_msgs::msg::rosidl_typesupport_cpp::DetectedObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mower_msgs, msg, DetectedObject)() {
  return get_message_type_support_handle<mower_msgs::msg::DetectedObject>();
}
