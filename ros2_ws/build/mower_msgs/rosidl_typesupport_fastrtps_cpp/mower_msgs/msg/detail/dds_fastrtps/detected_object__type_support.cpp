...
#include "mower_msgs/msg/detail/detected_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mower_msgs::msg::DetectedObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mower_msgs::msg::DetectedObject & ros_message)
{
  // Member: label
  cdr >> ros_message.label;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mower_msgs::msg::DetectedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mower_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mower_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  return &mower_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mower_msgs, msg, DetectedObject)() {
  return &mower_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
